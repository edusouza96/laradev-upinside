                                ...
                                @foreach ($property->images()->get() as $image)
                                    <div class="property_image_item">
                                        ...
                                        <div class="property_image_actions">
                                            ...
                                            <a href="javascript:void(0)" class="btn btn-small btn-red icon-times icon-notext image-remove" data-action="{{ route('admin.properties.imageRemove', ['image' => $image->id]) }}"></a>
                                        </div>
                                    </div>
                                @endforeach 
                            </div>
