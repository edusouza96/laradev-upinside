            ...
            <div class="dash_content_app_header_actions">
                <nav class="dash_content_app_breadcrumb">
                    <ul>
                        ...
                        <li class="separator icon-angle-right icon-notext"></li>
                        <li><a href="{{ route('admin.properties.create') }}" class="text-orange">Cadastrar Imóvel</a></li>
                    </ul>
                </nav>
            </div>
        </header>
                            ...
                            <div class="label_g2">
                                <label class="label">
                                    ...
                                    <select name="category" class="select2">
                                        <option value="Imóvel Residencial" {{ old('category') == 'residential_property' ? 'selected' : '' }}>Imóvel Residencial</option>
                            ...
                            <label class="label">
                                ...
                                <select name="user" class="select2">
                                    ...
                                    @foreach ($users as $user)
                                        @if(!empty($selected))
                                            <option value="{{ $user->id }}" {{ ($selected->id == $user->id ? 'selected' : '')}}>{{ $user->name }} ({{ $user->document }})</option>
                                        @else
