...
<head>
    ...
    <link rel="stylesheet" href="{{ url('backend/assets/css/libs.css') }}"/>
...
<div class="dash">
    <aside class="dash_sidebar">
        ...
        <ul class="dash_sidebar_nav">
            ...
            <li class="dash_sidebar_nav_item {{ isActive('admin.propeties') }}"><a class="icon-home" href="{{ route('admin.properties.index') }}">Imóveis</a>
                <ul class="dash_sidebar_nav_submenu">
                    <li class="{{ isActive('admin.users.index') }}"><a href="{{ route('admin.properties.index') }}">Ver Todos</a></li>
                    <li class="{{ isActive('admin.users.create') }}"><a href="{{ route('admin.properties.create') }}">Criar Novo</a></li>
                </ul>
            </li>
