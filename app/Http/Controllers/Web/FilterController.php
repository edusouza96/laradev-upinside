...
class FilterController extends Controller
{
    ...
    public function priceBase(Request $request)
    {
        ...
        if(session('sale') === true){
            $priceLimirProperties = $this->createQuery('sale_price as price');
        }else{
            $priceLimirProperties = $this->createQuery('rent_price as price');
        }

        if($priceLimirProperties->count()){
            foreach ($priceLimirProperties as $property) {
